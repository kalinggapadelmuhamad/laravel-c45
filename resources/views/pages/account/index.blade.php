                                ...
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="card profile-widget">
                                        ...
                                        <div class="card-footer">
                                            <a href="{{ route('account.edit', Auth::user()) }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('Roles') is-invalid

                                                    @enderror"
                                                        id="Roles" name="Roles" readonly
                                                    ...
                                                    {{-- <div class="selectgroup w-100">
                                                        ...
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="roles" value="User"
                                                                class="selectgroup-input"
                                                                {{ Auth::user()->role == 'User' ? 'checked' : '' }} readonly>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    @enderror"
                                                        data-height="150" name="address" readonly>{{ Auth::user()->address }}</textarea>
                                                    @error('address')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
