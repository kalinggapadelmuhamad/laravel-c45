        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Add Destinasi</div>
                </div>
            </div>
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="row">
                                                <div class="col-12 md-12 lg-12 text-center">
                                                    <img id="image-preview1" src="{{ asset('img/avatar/avatar-1.png') }}"
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="file-input1"
                                                            ...
                                                            onchange="previewImage1()" required>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col col-md-4 col-lg-4">
                                                    ...
                                                    <br>
                                                    <img id="image-preview2" src="{{ asset('img/avatar/avatar-1.png') }}"
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="form-group col-md-6 mb-3">
                                                    ...
                                                    <select name="lokasi" id="" class="form-control select2"
                                                        ...
                                                        @foreach ($lokasis as $lokasi)
                                                            <option value="{{ $lokasi->id }}">{{ $lokasi->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    {{-- <input type="text"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    @enderror"
                                                        data-height="150" name="address" required></textarea>
                                                    @error('address')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    @enderror"
                                                        data-height="150" name="desc" required></textarea>
                                                    @error('desc')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
